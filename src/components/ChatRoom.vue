...
export default {
  ...
  created () {
    axios.get(`https://warm-mountain-97356.herokuapp.com/api/v1/activites/chats/` + this.$route.params.id)
    .then(response => {
  ...
  methods: {
    ...
    onSubmit (evt) {
      ...
      axios.post(`https://warm-mountain-97356.herokuapp.com/api/v1/activites/chat/create`, this.chat)
      .then(response => {
